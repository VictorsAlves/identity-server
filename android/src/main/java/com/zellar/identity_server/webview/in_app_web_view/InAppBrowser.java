...
import com.zellar.identity_server.webview.InAppBrowserActivity;
import com.zellar.identity_server.webview.InAppBrowserOptions;
import com.zellar.identity_server.webview.Shared;
import com.zellar.identity_server.webview.Util;
import com.zellar.identity_server.webview.chrome_custom_tabs.ChromeCustomTabsActivity;
import com.zellar.identity_server.webview.chrome_custom_tabs.CustomTabActivityHelper;
...
public class InAppBrowser implements MethodChannel.MethodCallHandler{
    ...
    public Map<String, ChromeCustomTabsActivity> chromeCustomTabsActivities = new HashMap<String, com.zellar.identity_server.webview.chrome_custom_tabs.ChromeCustomTabsActivity>();
    ...
    public void evaluateJavascript(String uuid, String source, final MethodChannel.Result result) {
     ...
     */
    public void openExternal(Activity activity, String url, MethodChannel.Result result) {
        try {
            Intent intent;
    ...
    public void open(Activity activity, String uuid, String uuidFallback, String url, HashMap<String, Object> options, Map<String, String> headers, boolean useChromeSafariBrowser, HashMap<String, Object> optionsFallback, MethodChannel.Result result) {
    ...
    public void loadUrl(String uuid, String url, Map<String, String> headers, MethodChannel.Result result) {
        InAppBrowserActivity inAppBrowserActivity = webViewActivities.get(uuid);
        if (inAppBrowserActivity != null) {
            if (headers != null)
    ...
    public void postUrl(String uuid, String url, byte[] postData, MethodChannel.Result result) {
        InAppBrowserActivity inAppBrowserActivity = webViewActivities.get(uuid);
        if (inAppBrowserActivity != null)
            inAppBrowserActivity.postUrl(url, postData, result);
    }

    public void loadData(String uuid, String data, String mimeType, String encoding, String baseUrl, String historyUrl, MethodChannel.Result result) {
        InAppBrowserActivity inAppBrowserActivity = webViewActivities.get(uuid);
        if (inAppBrowserActivity != null)
            inAppBrowserActivity.loadData(data, mimeType, encoding, baseUrl, historyUrl, result);
    }

    public void loadFile(String uuid, String url, Map<String, String> headers, MethodChannel.Result result) {
        InAppBrowserActivity inAppBrowserActivity = webViewActivities.get(uuid);
        if (inAppBrowserActivity != null) {
            if (headers != null)
    ...
    public void close(Activity activity, final String uuid, final MethodChannel.Result result) {
        final InAppBrowserActivity inAppBrowserActivity = webViewActivities.get(uuid);
        if (inAppBrowserActivity != null) {
            activity.runOnUiThread(new Runnable() {
                @Override
    ...
    public void startSafeBrowsing(String uuid, MethodChannel.Result result) {
        InAppBrowserActivity inAppBrowserActivity = webViewActivities.get(uuid);
        if (inAppBrowserActivity != null)
    ...
    public void setSafeBrowsingWhitelist(String uuid, List<String> hosts, MethodChannel.Result result) {
        InAppBrowserActivity inAppBrowserActivity = webViewActivities.get(uuid);
        if (inAppBrowserActivity != null)
    ...
    public void clearClientCertPreferences(String uuid, MethodChannel.Result result) {
        InAppBrowserActivity inAppBrowserActivity = webViewActivities.get(uuid);
        if (inAppBrowserActivity != null)
    ...
    public void findNext(String uuid, Boolean forward, MethodChannel.Result result) {
        InAppBrowserActivity inAppBrowserActivity = webViewActivities.get(uuid);
        if (inAppBrowserActivity != null)
    ...
    public void clearMatches(String uuid, MethodChannel.Result result) {
        InAppBrowserActivity inAppBrowserActivity = webViewActivities.get(uuid);
        if (inAppBrowserActivity != null)
